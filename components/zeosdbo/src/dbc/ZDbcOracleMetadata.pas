...
function TZOracleDatabaseMetadata.GetProcedures(Catalog: string;
...
function TZOracleDatabaseMetadata.GetProcedureColumns(Catalog: string;
...
function TZOracleDatabaseMetadata.GetTables(Catalog: string;
  ...
  begin
    ...
    begin
      SQL := 'SELECT NULL AS TABLE_CAT, OWNER AS TABLE_SCHEM, TABLE_NAME,'
        ...
        + ' WHERE OWNER LIKE ''' + SchemaPattern + ''' AND TABLE_NAME LIKE '''
        + TableNamePattern + '''';
    end else
      SQL := '';
    ...
    begin
      PartSQL := 'SELECT NULL AS TABLE_CAT, OWNER AS TABLE_SCHEM,'
        ...
        + SchemaPattern + ''' AND SYNONYM_NAME LIKE ''' + TableNamePattern + '''';
    ...
    begin
      PartSQL := 'SELECT NULL AS TABLE_CAT, OWNER AS TABLE_SCHEM,'
        ...
        + SchemaPattern + ''' AND VIEW_NAME LIKE ''' + TableNamePattern + '''';
    ...
    begin
      PartSQL := 'SELECT NULL AS TABLE_CAT, SEQUENCE_OWNER AS TABLE_SCHEM,'
        ...
        + SchemaPattern + ''' AND SEQUENCE_NAME LIKE ''' + TableNamePattern + '''';
...
function TZOracleDatabaseMetadata.GetColumns(Catalog: string;
  SchemaPattern: string; TableNamePattern: string;
  ColumnNamePattern: string): IZResultSet;
var
  Key, SQL: string;
begin
  ...
  begin
    ...
    SQL := 'SELECT NULL, OWNER, TABLE_NAME, COLUMN_NAME, NULL, DATA_TYPE,'
      ...
      + ' WHERE OWNER LIKE ''' + SchemaPattern + ''' AND TABLE_NAME LIKE '''
      + TableNamePattern + ''' AND COLUMN_NAME LIKE '''
      + ColumnNamePattern + '''';
...
function TZOracleDatabaseMetadata.GetColumnPrivileges(Catalog: string;
...
begin
  ...
  begin
    ...
    SQL := SQL + ' COLUMN_NAME LIKE ''' + ColumnNamePattern + '''';
...
function TZOracleDatabaseMetadata.GetTablePrivileges(Catalog: string;
...
begin
  ...
  begin
    ...
    SQL := 'SELECT NULL AS TABLE_CAT, TABLE_SCHEMA AS TABLE_SCHEM, TABLE_NAME,'
      ...
      + ' FROM SYS.ALL_TAB_PRIVS WHERE TABLE_SCHEMA LIKE ''' + SchemaPattern
...
function TZOracleDatabaseMetadata.GetVersionColumns(Catalog: string;
...
function TZOracleDatabaseMetadata.GetPrimaryKeys(Catalog: string;
  Schema: string; Table: string): IZResultSet;
var
  SQL, Key: string;
begin
...
function TZOracleDatabaseMetadata.GetImportedKeys(Catalog: string;
  Schema: string; Table: string): IZResultSet;
begin
...
function TZOracleDatabaseMetadata.GetExportedKeys(Catalog: string;
  Schema: string; Table: string): IZResultSet;
begin
...
function TZOracleDatabaseMetadata.GetCrossReference(PrimaryCatalog: string;
...
function TZOracleDatabaseMetadata.GetIndexInfo(Catalog: string;
...
function TZOracleDatabaseMetadata.GetUDTs(Catalog: string;
