...
//---MySQL----------------------------------------------------------------------
  ...
  // keywords
  MySqlKW: string = 'ACTION,AFTER,AGGREGATE,ALL,ALTER,ANALYZE,AND,AS,ASC,'+
    ...
    'GRANTS,GROUP,HAVING,HEAP,HELP,HIGH_PRIORITY,HOSTS,IDENTIFIED,IGNORE,'+
    ...
    'NATURAL,NO,NOT,ON,OPTIMIZE,OPTION,OPTIONALLY,ORDER,OUTER,OUTFILE,'+
    'PACK_KEYS,PARTIAL,PRIMARY,PRIVILEGES,PROCEDURE,PROCESS,PROCESSLIST,'+
    'READ,REFERENCES,REGEXP,RELOAD,RENAME,REPAIR,RESTRICT,RETURNS,REVOKE,RLIKE,'+
    'ROW,ROWS,SELECT,SHOW,SHUTDOWN,SONAME,SQL_BIG_RESULT,SQL_BIG_SELECTS,'+
    'SQL_BIG_TABLES,SQL_BUFFER_RESULT,SQL_CACHE,SQL_CALC_FOUND_ROWS,'+
    'SQL_NO_CACHE,SQL_LOG_OFF,SQL_LOG_UPDATE,SQL_LOW_PRIORITY_UPDATES,'+
    ...
    'TYPE,UNION,UNIQUE,UNLOCK,UNSIGNED,UPDATE,USAGE,USE,USING,VALUES,'+
