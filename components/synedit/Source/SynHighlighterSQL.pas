...
//---MySQL----------------------------------------------------------------------
  ...
  MySQLFunctions: UnicodeString =
    ...
    'CEILING,CENTROID,CHARACTER_LENGTH,CHAR_LENGTH,CHR,COALESCE,' +
    'COERCIBILITY,COLUMN_ADD,COLUMN_CHECK,COLUMN_CREATE,COLUMN_DELETE,' +
    'COLUMN_EXISTS,COLUMN_GET,COLUMN_JSON,COLUMN_LIST,COMPRESS,CONCAT,' +
    'CONCAT_WS,CONNECTION_ID,CONV,CONVERT_TZ,CONVEXHULL,COS,COT,COUNT,CRC32,' +
    'CROSSES,CUME_DIST,CURDATE,CURRENT_DATE,CURRENT_ROLE,CURRENT_TIME,' +
    ...
    'HELP_DATE,HEX,HOUR,IFNULL,INET6_ATON,INET6_NTOA,INET_ATON,INET_NTOA,' +
    'INSTR,INTERIORRINGN,INTERSECTS,INTERVAL,ISCLOSED,ISEMPTY,ISNULL,ISRING,' +
    'ISSIMPLE,IS_FREE_LOCK,IS_IPV4,IS_IPV4_COMPAT,IS_IPV4_MAPPED,IS_IPV6,' +
    ...
    'JSON_EXISTS,JSON_EXTRACT,JSON_INSERT,JSON_KEYS,JSON_LENGTH,JSON_LOOSE,' +
    'JSON_MERGE,JSON_OBJECT,JSON_QUERY,JSON_QUOTE,JSON_REMOVE,JSON_REPLACE,' +
    'JSON_SEARCH,JSON_SET,JSON_TYPE,JSON_UNQUOTE,JSON_VALID,JSON_VALUE,' +
    'LABELS,LAG,LASTVAL,LAST_DAY,LAST_INSERT_ID,LAST_VALUE,LCASE,LEAST,LEFT,' +
    'LENGTH,LENGTHB,LINEFROMTEXT,LINEFROMWKB,LINESTRINGFROMTEXT,' +
    'LINESTRINGFROMWKB,LN,LOAD_FILE,LOCALTIME,LOCALTIMESTAMP,LOCATE,LOG,' +
    'LOG10,LOG2,LOWER,LPAD,LTRIM,MAKEDATE,MAKETIME,MAKE_SET,' +
    'MASTER_GTID_WAIT,MASTER_POS_WAIT,MAX,MBRCONTAINS,MBRDISJOINT,MBREQUAL,' +
    ...
    'POWER,QUARTER,QUOTE,RADIANS,RAND,RANK,REGEXP_INSTR,REGEXP_REPLACE,' +
    'REGEXP_SUBSTR,RELEASE_LOCK,REVERSE,RIGHT,ROUND,ROW_COUNT,ROW_NUMBER,' +
    'RPAD,RTRIM,SECOND,SEC_TO_TIME,SESSION_USER,SETVAL(),SHA1,SHA2,SIGN,SIN,' +
    'SLEEP,SOUNDEX,SPACE,SPIDER_BG_DIRECT_SQL,SPIDER_COPY_TABLES,' +
