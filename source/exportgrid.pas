...
uses
  ...
  Dialogs, StdCtrls, ExtCtrls, Menus, ComCtrls, laz.VirtualTrees, SynExportHTML, ActnList,
...
type
  ...
  TfrmExportGrid = class(TExtForm)
    ...
    editFilename: TEditButton;
    grpOptions: TGroupBox;
    chkIncludeColumnNames: TCheckBox;
    editSeparator: TEditButton;
    editEncloser: TEditButton;
    editTerminator: TEditButton;
    lblSeparator: TLabel;
    lblEncloser: TLabel;
    ...
    lblNull: TLabel;
    editNull: TEditButton;
    btnSetClipboardDefaults: TSpeedButton;
...
begin
  ...
  if radioOutputFile.Checked then begin
    Filename := ExtractFilePath(editFilename.Text) +
      GetFileNameWithoutExtension(editFilename.Text) +
